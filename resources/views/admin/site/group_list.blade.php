...
@section('content')
    <div class="x-nav">
        ...
        <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="{{url('admin/group_list')}}" title="刷新">
            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    <div class="layui-card-header">
                        <a class="layui-btn" onclick="xadmin.open('添加角色','{{url('admin/add_group')}}')" href="javascript:;"><i class="layui-icon"></i>添加角色</a>
                    </div>
                        ...
                        <table class="layui-table layui-form">
                            ...
                            @foreach($list as $val)
                                <tr>
                                    ...
                                    <td class="td-manage">
                                        <a  onclick="xadmin.open('角色编辑','{{url('admin/edit_group',['id'=>$val->id])}}')" href="javascript:;" class="layui-btn layui-btn-xs layui-btn-radius layui-btn-normal">
                                            编辑
                                        </a>
