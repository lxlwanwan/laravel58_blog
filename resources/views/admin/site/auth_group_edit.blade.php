            ...
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 250px;">
                        <input type="text" value="{{$data->controller}}" readonly="readonly" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="phone" class="layui-form-label">
                    ...
                    <div class="layui-input-inline" style="width: 100px">
                        <input type="text" id="icon" name="icon" value="{{$data->icon}}" autocomplete="off"
                               class="layui-input">
                    </div>
                    <div class="layui-form-mid layui-word-aux">请参考<a target="_blank" href="https://www.layui.com/doc/element/icon.html">图标</a></div>
                </div>
                <div class="layui-form-item">
                    <label for="phone" class="layui-form-label">
        ...
        layui.use(['form', 'layer'], function () {
            ...
            form.on('submit(edit)', function (data) {
                $.ajax({
                    ...
                    data:{id:data.field.id,name:data.field.name,_token:data.field._token,icon:data.field.icon,order:data.field.order},
                    dataType:'json',
